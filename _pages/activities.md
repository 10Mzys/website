...
<div class="activities-wrap">
  ...
  <section class="activities-section">
    <h2 class="activities-heading">Professional Service</h2>
    <div class="service-card">
      <span class="service-label">Reviewer:</span>
      Journal of Machine Learning Research (JMLR), Annals of Statistics, IEEE Transactions on Information Theory,
      Electronic Journal of Statistics, Journal of Statistical Planning and Inference, ICML, NeurIPS, AISTATS, and ICLR.
    </div>
  </section>

  <section class="activities-section">
    <h2 class="activities-heading">Talks &amp; Conferences</h2>
    ...
    <div class="activity-year">2024</div>
    <div class="activity-list">
      <div class="activity-item">
    ...
    <div class="activity-year">2023</div>
    <div class="activity-list">
      <div class="activity-item">
    ...
    <div class="activity-year">2022</div>
    <div class="activity-list">
      <div class="activity-item">
